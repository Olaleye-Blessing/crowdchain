export const crowdChainABI = [
  ...
  "function getCampaigns(uint256 page, uint256 perPage) external view returns (tuple(uint256 id, uint256 amountRaised, uint256 deadline, uint256 refundDeadline, uint256 goal, address owner, string title, string description, string coverImage, bool claimed, uint256 totalDonors)[], uint256)",
